 ...
 */ 
 ...
 $query = 
 'SELECT message_id, user_name, message, color, ' . 
 ...
 $query = 
 ' SELECT message_id, user_name, message, color, posted_on FROM ' . 
 ' (SELECT message_id, user_name, message, color, ' ' DATE_FORMAT(posted_on, "%Y-%m-%d %H:%i:%s") AS posted_on ' . 
 ' FROM chat ' . 
